...
echo "select chrom,txStart,txEnd from wgEncodeGencodeBasicV27lift37 where chrom = 'chr1'" > /path/to/path/to/radia/data/hg19/gencode/basic/chr1_unsorted.bed
...
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr1_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr1.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr2_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr2.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr3_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr3.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr4_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr4.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr5_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr5.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr6_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr6.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr7_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr7.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr8_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr8.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr9_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr9.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr10_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr10.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr11_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr11.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr12_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr12.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr13_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr13.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr14_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr14.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr15_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr15.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr16_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr16.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr17_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr17.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr18_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr18.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr19_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr19.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr20_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr20.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr21_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr21.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chr22_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chr22.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chrX_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chrX.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chrY_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chrY.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chrM_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chrM.bed.gz
sort -t $'\t' +1n -3 /radia/data/hg19/gencode/basic/chrMT_unsorted.bed | gzip > /path/to/radia/data/hg19/gencode/basic/chrMT.bed.gz
